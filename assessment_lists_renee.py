...
def all_odd(numbers):
    ...
    # for num in numbers:           # making myself try comprehension...
    #     if num % 2 != 0:
    #         odd_numbers.append(num)

    odd_numbers = [num for num in numbers if num % 2 != 0]  # huzzah!
...
def print_indices(items):
    ...
    """
    #looping through RANGE of same length, rather than the list itself
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    set_foods_in_common = set_foods1 & set_foods2
    foods_in_common_list = list(set_foods_in_common)
...
def largest_n_items(items, n):
    ...
    if n == 0:          # to clear the 0 possibility. (-0)
        return []
    else:
        n_items = items[-n:]
